...
.. directive_wrapper::
   ...
   .. service_card::
      ...
      :dev-guide: This document describes how to call the Elastic Volume Service (EVS) APIs to use various EVS functions.

   .. service_card_link::
      :title: Best Practices
      :url: https://arch.otc-service.com/docs/best-practices/storage/elastic-volume-service
