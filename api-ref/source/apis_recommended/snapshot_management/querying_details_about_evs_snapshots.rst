...
-  Request parameters
   ...
   +===========+=========+===========+===============================================================================================================================================================================================================================================================================================================+
   | offset    | Integer | No        | The query offset. This parameter is used for pagination query and is used together with the **limit** parameter. Assume that there are 30 snapshots. If you set **offset** to **11** and **limit** to **10**, the query starts from the twelfth snapshot. A maximum of 10 snapshots can be queried at a time. |
   +-----------+---------+-----------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
