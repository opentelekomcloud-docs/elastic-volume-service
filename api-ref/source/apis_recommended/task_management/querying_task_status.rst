...
The following example shows how to query the status of the task whose ID is **ff808081692a62c70169b4dcf9514264**.
...
-  .. _evs_04_0054__li134182540818:
   ...
   Parameters in the **entities** field
   ...
   +-------------+------------------+------------------------------------------------------------------------------------------------------------------------+
   | size        | Integer          | The disk capacity, in GB.                                                                                              |
   +-------------+------------------+------------------------------------------------------------------------------------------------------------------------+
