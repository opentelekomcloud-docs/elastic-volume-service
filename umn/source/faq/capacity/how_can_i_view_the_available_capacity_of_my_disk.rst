...
2. Query the disk capacity. Two methods are provided as follows:
   ...
   -  View the disk usage manually.
      ...
      The details depend on the OS. This FAQ uses Windows Server 2016 and Linux as examples to describe how to view the disk usage.
...
#. Click **Server Manager**.
   ...
   .. figure:: /_static/images/en-us_image_0000002313462141.png
      :alt: **Figure 1** Server Manager page

      **Figure 1** Server Manager page
...
#. Choose **Storage** > **Disk Management**.
   ...
   .. figure:: /_static/images/en-us_image_0000002278862488.png
      :alt: **Figure 2** Disk list page

      **Figure 2** Disk list page
...
.. table:: **Table 1** Disk metrics
   ...
   +==================+===============================+=======================================================================================================================================================================================================================================================================+=============+========+=================+=========================+==============================+
   | disk_free        | (Agent) Available Disk Space  | Free space on the disks                                                                                                                                                                                                                                               | >= 0        | GB     | N/A             | instance_id,mount_point | 1 minute                     |
   |                  |                               |                                                                                                                                                                                                                                                                       |             |        |                 |                         |                              |
   ...
   +------------------+-------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------+--------+-----------------+-------------------------+------------------------------+
   | disk_total       | (Agent) Disk Storage Capacity | Total space on the disks, including used and free                                                                                                                                                                                                                     | >= 0        | GB     | N/A             | instance_id,mount_point | 1 minute                     |
   |                  |                               |                                                                                                                                                                                                                                                                       |             |        |                 |                         |                              |
   ...
   |                  |                               | -  Windows: Use the WMI interface to call GetDiskFreeSpaceExW API to obtain disk space data. The path of the mount point prefix cannot exceed 64 characters. It must start with a letter, and contain only digits, letters, hyphens (-), periods (.), and tildes (~). |             |        |                 |                         |                              |
   +------------------+-------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------+--------+-----------------+-------------------------+------------------------------+
   | disk_used        | (Agent) Used Disk Space       | Used space on the disks                                                                                                                                                                                                                                               | >= 0        | GB     | N/A             | instance_id,mount_point | 1 minute                     |
   |                  |                               |                                                                                                                                                                                                                                                                       |             |        |                 |                         |                              |
   ...
   |                  |                               | -  Windows: Use the WMI interface to call GetDiskFreeSpaceExW API to obtain disk space data. The path of the mount point prefix cannot exceed 64 characters. It must start with a letter, and contain only digits, letters, hyphens (-), periods (.), and tildes (~). |             |        |                 |                         |                              |
   +------------------+-------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------+--------+-----------------+-------------------------+------------------------------+
   | disk_usedPercent | (Agent) Disk Usage            | Percentage of total disk space that is used, which is calculated as follows: **Disk Usage** = **Used Disk Space**/**Disk Storage Capacity**                                                                                                                           | 0-100       | %      | N/A             | instance_id,mount_point | 1 minute                     |
   |                  |                               |                                                                                                                                                                                                                                                                       |             |        |                 |                         |                              |
